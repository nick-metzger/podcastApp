...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata2(InjectableAnimationEngine, [{
    type: Injectable2
  }], () => [{
    type: Document,
    decorators: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata2(BrowserAnimationsModule, [{
    type: NgModule,
    args: [{
      exports: [BrowserModule],
      providers: BROWSER_ANIMATIONS_PROVIDERS
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata2(NoopAnimationsModule, [{
    type: NgModule,
    args: [{
      exports: [BrowserModule],
      providers: BROWSER_NOOP_ANIMATIONS_PROVIDERS
